...
// Import the CommandKit to allow commands in Discord to be used
...
// Instantiate the Commandkit with its constraints
new CommandKit({
  client,
...
// Updated the client is ready log to log a more descriptive message to the console
client.on("ready", (c) => {
